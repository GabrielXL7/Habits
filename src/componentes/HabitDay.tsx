...
// ANIMAÇÃO DE QUANDO CLICAR EM UM QUADRADO DE DIAS
    ...
    return(
        ...
        <Popover.Portal>
            <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                ...
                <span className='mt-1 font-extrabold leading-tight text-3xl'>13/04</span>
                ...
                <span className='font-semibold text-xl text-white leading-tight group-data-[state=checked]:line-throuh'>
                    Beber 2L de água
                </span>
                </Checkbox.Root>
                </div>
